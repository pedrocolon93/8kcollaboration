...
public class GrabRotateScript : MonoBehaviour 
{
	...
	void Update() 
	{
		manager = GetComponent<InteractionManager>().instance;

		if(manager != null && manager.IsInteractionInitiated())
		{
	...
	void OnGUI()
	{
		if(infoGuiText != null && manager != null && manager.IsInteractionInitiated())
		{
