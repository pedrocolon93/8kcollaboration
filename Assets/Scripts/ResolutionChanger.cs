...
public class ResolutionChanger : MonoBehaviour {
    ...
    public List<Tuple<int,int>> resolutionsList = new List<Tuple<int, int>>(new Tuple<int, int>[] { new Tuple<int, int>(1920,1080), new Tuple<int, int>(3840, 2160), new Tuple<int, int>(7680, 4320)});
